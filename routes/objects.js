...
exports.addObject = function(req, res) {
    var object = req.body;
    console.log('Adding task: ' + JSON.stringify(object));
    db.collection(collection, function(err, collection) {
...
exports.updateTasksDate = function(req, res){
    db.collection(updateCollection, function(err, collection){
        collection.remove();
...
exports.getTasksDate = function(req, res){
    db.collection(updateCollection, function(err, collection){
...
var populateDB = function() {
    ...
    var wines = [
    {
        ...
        description: "The aromas of fruit and spice give one a hint of the light drinkability of this lovely task, which makes an excellent complement to fish dishes.",
    ...
    },
    {
        ...
        country: "Spain",
        region: "Rioja",
        description: "A resurgence of interest in boutique vineyards has opened the door for this excellent foray into the dessert task market. Light and bouncy, with a hint of black truffle, this task will not fail to tickle the taste buds.",
    ...
    },
    {
        ...
        description: "The cache of a fine Cabernet in ones task cellar can now be replaced with a childishly playful task bubbling over with tempting tastes of black cherry and licorice. This is a taste sure to transport you back in time.",
    ...
    },
    {
        ...
        country: "USA",
        region: "Oregon",
        description: "One cannot doubt that this will be the task served at the Hollywood award shows, because it has undeniable star power. Be the first to catch the debut that everyone will be talking about tomorrow.",
    ...
    },
    {
        ...
        country: "Italy",
        region: "Tuscany",
        description: "Though soft and rounded in texture, the body of this task is full and rich and oh-so-appealing. This delivery is even more impressive when one takes note of the tender tannins that leave the taste buds wholly satisfied.",
    ...
    },
    {
        ...
        country: "France",
        region: "Bordeaux",
        description: "Though dense and chewy, this task does not overpower with its finely balanced depth and structure. It is a truly luxurious experience for the senses.",
    ...
    },
    {
        ...
        country: "France",
        region: "Bordeaux",
        description: "The light golden color of this task belies the bright flavor it holds. A true summer task, it begs for a picnic lunch in a sun-soaked vineyard.",
        picture: "bouscat.jpg"
    },
    {
        name: "BLOCK NINE",
        ...
        country: "USA",
        region: "California",
        description: "With hints of ginger and spice, this task makes an excellent complement to light appetizer and dessert fare for a holiday gathering.",
    ...
    },
    {
        ...
        country: "USA",
        region: "Oregon",
        description: "Though subtle in its complexities, this task is sure to please a wide range of enthusiasts. Notes of pomegranate will delight as the nutty finish completes the picture of a fine sipping experience.",
    ...
    },
    {
        ...
        country: "Argentina",
        region: "Mendoza",
        description: "Solid notes of black currant blended with a light citrus make this task an easy pour for varied palates.",
    ...
    },
    {
        ...
        country: "France",
        region: "Alsace",
        description: "Fresh as new buds on a spring vine, this dewy offering is the finest of the new generation of pinot grigios.  Enjoy it with a friend and a crown of flowers for the ultimate task tasting experience.",
        picture: "hugel.jpg"
    },
    {
    ...
    },
    {
        ...
        country: "New Zealand",
        region: "South Island",
        description: "Best served chilled with melon or a nice salty prosciutto, this sauvignon blanc is a staple in every Italian kitchen, if not on their task list.  Request the best, and you just may get it.",
        picture: "momo.jpg"
    },
    {
        name: "WATERBROOK",
